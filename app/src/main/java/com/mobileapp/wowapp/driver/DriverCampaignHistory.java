...
public class DriverCampaignHistory extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_driver_campaign_history);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Animatoo.INSTANCE.animateSlideRight(DriverCampaignHistory.this);
            }
        });
        ...
        showLoading();
        manager.getRequest(APIList.GET_DRIVER_CAMPAIGN_HISTORY, new IResultData() {
            @Override
